...
private:
    ...
    QMenu   *playerBoxMenu = nullptr;
    QAction *playerSaveData = nullptr;

    QMenu   *enemyBoxMenu = nullptr;
    QAction *enemySaveData = nullptr;

    QMenu   *propBoxMenu = nullptr;
    QAction *propSaveData = nullptr;

    QMenu   *magicBoxMenu = nullptr;
    QAction *magicSaveData = nullptr;
...
private slots:
    ...
    void on_playerSaveData();
    void on_enemySaveData();
    void on_propSaveData();
    void on_magicSaveData();

    void on_playerBox_customContextMenuRequested(const QPoint &pos);
    void on_enemyBox_customContextMenuRequested(const QPoint &pos);
    void on_propBox_customContextMenuRequested(const QPoint &pos);
    void on_magicBox_customContextMenuRequested(const QPoint &pos);
